namespace QA.TILS.Modules.Users.Core.Pages.LoginPage
{
    ...
    {       
        ...
        public HtmlInputSubmit LoginButton
        {
            get
            {
                return this.Find.ByAttributes<HtmlInputSubmit>("generalButtonStyles normalButton greenButton".ToIsClassExpression());
            }
        }
        ...
        public HtmlAnchor ForgottenPasswordLink
        {
            get
            {
                return this.Find.ByAttributes<HtmlAnchor>("http://test.telerikacademy.com/Users/Auth/ForgottenPassword".ToLinkPointsToExpression());
            }
        }
        ...
        public HtmlDiv InvalidLoginErrorDiv
        {
            get
            {
                return this.Find.ByAttributes<HtmlDiv>("validation-summary-errors".ToIsClassExpression());
            }
        }
    }
}
